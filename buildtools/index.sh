...
function render_github_button() {
  envsubst <<ELEM
<button class="tablinks" onclick="location.href='${HOMEPAGE}';">
  <img src="resources/images/github.png" width="60px;20px" onclick="location.href = '${HOMEPAGE}';" align="middle"/>
</button>
ELEM
}
...
function render_content() {
  ...
  echo '<a href="'${_filestem}'.html" target="_blank">open this page in a new window</a>'
  echo '</p></div>'
  echo '</div>'
}
